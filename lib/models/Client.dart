...
class Client extends amplify_core.Model {
  ...
  const Client._internal({required this.id, required companyName, required personName, required position, required contactNumber, required email, required address, required onboardDate, createdAt, updatedAt}): _companyName = companyName, _personName = personName, _position = position, _contactNumber = contactNumber, _email = email, _address = address, _onboardDate = onboardDate, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Client({String? id, required String companyName, required String personName, required String position, required String contactNumber, required String email, required String address, required amplify_core.TemporalDateTime onboardDate}) {
  ...
  String toString() {
    ...
    buffer.write("onboardDate=" + (_onboardDate != null ? _onboardDate!.format() : "null") + ", ");
  ...
  Client copyWith({String? companyName, String? personName, String? position, String? contactNumber, String? email, String? address, amplify_core.TemporalDateTime? onboardDate}) {
    return Client._internal(
      id: id,
  ...
  Client copyWithModelFieldValues({
    ...
    return Client._internal(
      ...
      onboardDate: onboardDate == null ? this.onboardDate : onboardDate.value
    );
  }
  ...
  Client.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _onboardDate = json['onboardDate'] != null ? amplify_core.TemporalDateTime.fromString(json['onboardDate']) : null,
      _createdAt = json['createdAt'] != null ? amplify_core.TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? amplify_core.TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'companyName': _companyName, 'personName': _personName, 'position': _position, 'contactNumber': _contactNumber, 'email': _email, 'address': _address, 'onboardDate': _onboardDate?.format(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
