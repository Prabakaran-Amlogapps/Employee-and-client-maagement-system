...
class Profile extends amplify_core.Model {
  ...
  const Profile._internal({required this.id, required name, required companyName, required industry, required numberOfEmployees, required address, required contact, required email, updatedAt, createdAt}): _name = name, _companyName = companyName, _industry = industry, _numberOfEmployees = numberOfEmployees, _address = address, _contact = contact, _email = email, _updatedAt = updatedAt, _createdAt = createdAt;
  
  factory Profile({String? id, required String name, required String companyName, required String industry, required int numberOfEmployees, required String address, required String contact, required String email, amplify_core.TemporalDateTime? updatedAt}) {
  ...
  String toString() {
    ...
    buffer.write("numberOfEmployees=" + (_numberOfEmployees != null ? _numberOfEmployees!.toString() : "null") + ", ");
  ...
  Profile copyWith({String? name, String? companyName, String? industry, int? numberOfEmployees, String? address, String? contact, String? email, amplify_core.TemporalDateTime? updatedAt}) {
    return Profile._internal(
      id: id,
      name: name ?? this.name,
  ...
  Profile copyWithModelFieldValues({
    ...
    return Profile._internal(
      ...
      numberOfEmployees: numberOfEmployees == null ? this.numberOfEmployees : numberOfEmployees.value,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'companyName': _companyName, 'industry': _industry, 'numberOfEmployees': _numberOfEmployees, 'address': _address, 'contact': _contact, 'email': _email, 'updatedAt': _updatedAt?.format(), 'createdAt': _createdAt?.format()
  };
  ...
  static final NUMBEROFEMPLOYEES = amplify_core.QueryField(fieldName: "numberOfEmployees");
