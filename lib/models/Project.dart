...
class Project extends amplify_core.Model {
  ...
  const Project._internal({required this.id, required projectName, required clientName, required projectDate, required location, required contactPerson, required contactNumber, required totalCost, required createdAt, required updatedAt}): _projectName = projectName, _clientName = clientName, _projectDate = projectDate, _location = location, _contactPerson = contactPerson, _contactNumber = contactNumber, _totalCost = totalCost, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Project({String? id, required String projectName, required String clientName, required amplify_core.TemporalDateTime projectDate, required String location, required String contactPerson, required String contactNumber, required double totalCost, required amplify_core.TemporalDateTime createdAt, required amplify_core.TemporalDateTime updatedAt}) {
  ...
  String toString() {
    ...
    buffer.write("projectDate=" + (_projectDate != null ? _projectDate!.format() : "null") + ", ");
    buffer.write("location=" + "$_location" + ", ");
    buffer.write("contactPerson=" + "$_contactPerson" + ", ");
    buffer.write("contactNumber=" + "$_contactNumber" + ", ");
    buffer.write("totalCost=" + (_totalCost != null ? _totalCost!.toString() : "null") + ", ");
  ...
  Project copyWith({String? projectName, String? clientName, amplify_core.TemporalDateTime? projectDate, String? location, String? contactPerson, String? contactNumber, double? totalCost, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt}) {
    return Project._internal(
      id: id,
  ...
  Project copyWithModelFieldValues({
    ...
    return Project._internal(
      ...
      contactPerson: contactPerson == null ? this.contactPerson : contactPerson.value,
  ...
  Project.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _projectDate = json['projectDate'] != null ? amplify_core.TemporalDateTime.fromString(json['projectDate']) : null,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'projectName': _projectName, 'clientName': _clientName, 'projectDate': _projectDate?.format(), 'location': _location, 'contactPerson': _contactPerson, 'contactNumber': _contactNumber, 'totalCost': _totalCost, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final CONTACTPERSON = amplify_core.QueryField(fieldName: "contactPerson");
